...
high_altitude_bounds = [50, 150]; % Height Boundary for drone nodes
...
C3 = Cluster(lat_c1, lon_c1, 500, 0, 0, high_altitude_bounds, "dome");
C4 = Cluster(lat_c2, lon_c2, 500, 0, 0, high_altitude_bounds, "slice");
...
% -- Save File -- 
fileName = sprintf('PowerSimResults_%s.mat', datetime("now"));

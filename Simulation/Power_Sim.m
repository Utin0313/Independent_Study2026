...
C1_x = 350; C2_x = 50; C3_x = 100; C4_x = 100;
C1_y = 50; C2_y = 50; C3_y = 500; C4_y = 100;
...
C3 = Cluster(lat_c1, lon_c1, 50, bound_x_deg_c3, bound_y_deg_c3, high_altitude_bounds);
C4 = Cluster(lat_c2, lon_c2, 50, bound_x_deg_c4, bound_y_deg_c4, high_altitude_bounds);
